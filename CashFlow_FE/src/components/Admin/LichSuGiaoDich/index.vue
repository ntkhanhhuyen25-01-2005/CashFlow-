      ...
      <div class="card-header bg-white">
        <div class="d-flex flex-wrap gap-2 align-items-end">
          ...
          <div class="ms-auto d-flex gap-2">
            ...
            <!-- Nút Đặt lại => mở modal -->
            <button class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#resetModal">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            Bạn có chắc chắn muốn <strong>đặt lại bộ lọc</strong> không?
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Hủy</button>
            <button type="button" class="btn btn-primary" data-bs-dismiss="modal" @click="resetFilters">
              Đồng ý
            </button>
          </div>
        </div>
